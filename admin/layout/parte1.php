...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo APP_URL; ?>/admin" class="brand-link">
      <img src="https://cdn-icons-png.flaticon.com/512/3798/3798280.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Redes de Salvación</span>
    </a>
